    ...
    <>
      <section className="relative pt-32 pb-20 hero-bg overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <span className="badge-teal mb-4 inline-block">Legal</span>
      ...
      <section className="section-pad bg-navy-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
          {content.sections.map((section) => (
            <div key={section.heading} className="card-dark gradient-border glow-card p-8 rounded-2xl">
              <h2 className="text-white font-bold text-lg mb-3 flex items-start gap-2">
              ...
              <p className="text-gray-400 leading-relaxed text-sm pl-6">{section.body}</p>
            </div>
          ))}
        </div>
      </section>
